...
const updateTransactionService = (body, id, paymentProof) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (paymentProof) {
        secure_url = (yield (0, cloudinary_1.cloudinaryUpload)(paymentProof))
          .secure_url;
      }
      ...
      if (
        ...
        body.status === client_1.Status.REJECTED
      ) {
        const template = yield (0, TemplateUtils_1.loadEmailTemplate)();
        const emailContent = (0, TemplateUtils_1.replaceTemplateVariables)(
          template,
          {
        ...
        if (body.status === client_1.Status.REJECTED) {
          yield nodemailer_1.transporter.sendMail({
            ...
            <ul>
              ...
              <li>Amount: ${(0, TemplateUtils_1.formatCurrency)(
